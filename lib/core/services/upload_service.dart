...
class UploadService {
  ...
  Future documentConvertion(
    ...
    try {
      ...
      print('start size before write $received');
      if (res.contentLength == 0) {
        return res.contentLength;
      }

      String getDir = await ExternalPath.getExternalStoragePublicDirectory(ExternalPath.DIRECTORY_DOCUMENTS);
      ...
      if (await fullFolderDirToSave.exists()) {
        res.stream.listen(
          ...
          print('start size after write  $received');
